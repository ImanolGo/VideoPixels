...
public:
    ...
    static ofUTF8Iterator_ iterator(const ofUTF8String& input);
    static ofUTF8Iterator_ begin(const ofUTF8String& input);
    static ofUTF8Iterator_ end(const ofUTF8String& input);
